...
export const API_DIR = "https://api.spotify.com/v1";
const el = Component;
...
export const sdk = function (authToken) {
    let authToken = authToken;
    return {
        fetchAPI, fetchAPIPut, queueTrack, getTracks, playNext,


    }
}
export const fetchAPI = (uri, method = "GET") =>
    fetch(API_DIR + uri, {
        method: method,
...
export const fetchAPIPut = (uri, body) =>
    fetch(API_DIR + uri, {
        method: "PUT",
...
export function tokenValid() {
    const { access_token, refresh_token, expiry } = hashParams();
    return access_token || new Date().getTime() > expiry;
}
