...
export const PlayListMenu = ({ playlists, t }) => {
...
export const TrackList = ({ trackName, trackId }) => {
    <div>{trackName}{trackId}</div>
}
export const AppBarTop = ({ accessToken, loginUrl }) => {
    return (
...
export const NowPlaying = () => <div>Now Playing</div>
...
export const SongList = ({ songs }) => {
    ...
    function renderSongs() {
        return songs.map((song, i) => {
            const buttonClass =
                song.track.id === props.songId && !props.songPaused
                    ? "fa-pause-circle-o"
                    : "fa-play-circle-o";
