export default function printMe() {
    console.log('I get called from aaaaaprint.js!');
    console.log('Updating print.js...');
}
import { Q, HZ_LIST } from './constants.js';

class AudacityEQ extends AudioWorkletNode {
    constructor() {
        super();
    ...
    static get parameterDescriptor() {
        {
            return [
                {
                    name: 'presetGains', default: [0.375, 0.375, 0.375, 0.375, 0.375, 0.375, 0, 0, 0, 0]
                }, {
...
registerProcessor('audacity-eq-processor', AudacityEQ);
